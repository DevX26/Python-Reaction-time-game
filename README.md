# Python-Reaction-time-game
This is a simple game to test your reaction time, coded using python. 
An EXE is alo avalible if you are not able to use python!
...
Randomized reaction trigger to test reflexes
Local leaderboard with top 10 scores
Optional leaderboard sync via Google Drive
Retry and reset options for continuous play
